...
const (
	MergeWriteNew mergeAction = iota
	MergeUserMustResolveMerge
	MergeUserEditedButWantToDelete
	MergeUserDeletedButWantToUpdate
	MergeDelete
	MergeNoop
)
...
func decideMerge(o *decideMergeParams) (*mergeDecision, error) {
	...
	case o.IsInOldManifest && o.IsInNewManifest:
		...
		case Deleted:
			...
			return &mergeDecision{
				action:           MergeUserDeletedButWantToUpdate,
...
func actuateMergeDecision(ctx context.Context, fs common.FS, dryRun bool, decision *mergeDecision, installedDir, mergeDir, relPath string) error {
	...
	case MergeUserMustResolveMerge:
		if dryRun {
			return nil
		}
