...
func TestUpgrade(t *testing.T) {
	...
	cases := []struct {
		...
		// // these directories will both be placed in subdirectories of a
		// // per-subtest temp directory. That temp directory will be a git repo
		// // (to satisfy the "same workspace" checks).
		// destDirContents     map[string]string
		origTemplateDirContents   map[string]string
		wantDestDirContentsBefore map[string]string
...
template_dirhash: h1:TbMuB+SzsgAJxxnAp6UDjOkyRdKfMFvjN0qAmBHrXG8=
inputs: []
output_hashes:
    - file: out.txt
...
location_type: local_git
template_version: 5597fc600ead69ad92c81a22b58c9e551cd86b9a
template_dirhash: h1:sCf2Um3hjTgQ4mCvmlExS1Zfc9d55MATyrjreBzw+eg=
inputs: []
output_hashes:
    - file: out.txt
...
`,
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			// TODO explain all of this, why render followed by upgrade
			...
			// Now create the "new" template that we'll upgrade to. This is implemented
			// as a patch over the previous version.
