...
`,
		...
		{
			name:          "force_manifest_filename",
			forceBaseName: "my_manifest.yaml",
			templateContents: map[string]string{
				"spec.yaml": "some stuff",
				"a.txt":     "some other stuff",
			},
			...
			want: map[string]string{
				"a.txt": "some other stuff",
				".abc/my_manifest.yaml": `# Generated by the "abc templates" command. Do not modify.
api_version: cli.abcxyz.dev/v1beta5
kind: Manifest
creation_time: 2023-12-08T23:59:02.000000013Z
modification_time: 2023-12-08T23:59:02.000000013Z
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			err := writeManifest(&writeManifestParams{
				...
				dlMeta:        tc.dlMeta,
				dryRun:        tc.dryRun,
				forceBaseName: tc.forceBaseName,
				fs:            &common.RealFS{},
				inputs:        tc.inputs,
